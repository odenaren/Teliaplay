...
export function TitelKort({
   ...
   *
   * Ordningen kommer FRÅN FRÅGAN, sorterad på tjanst.prioritet. Kortet
   * sorterar inte om: Spela-knappen tar första tjänsten i listan, och den
   * ska vara den du valt att föredra — inte den som råkade komma först ur
   * databasen, och inte en ordning som en komponent hittar på för sig själv.
   */
